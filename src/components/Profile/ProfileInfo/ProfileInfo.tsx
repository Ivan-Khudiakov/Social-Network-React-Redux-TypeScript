    ...
    return (
        <div>
            <div className={styles.descriptionBlock}>
                <img src={profile.photos?.large || userPhoto} className={styles.avatar} alt={'avatar'}/>
    ...
    return <div>
        ...
        <div>
            ...
            Object
                ...
                .map((key)  => {
                    return <Contact key={key} contactTitle={key} contactValue={profile.contacts? profile.contacts[key as keyof ContactsType] : null}/>
                })}
        </div>
    </div>
}
